    ...
    public class InvestmentService : IInvestmentService
    {
        ...
        void SetupInvestmentAccounts()
        {
            investmentAccounts.AddRange(new List<InvestmentAccount>
            {
                ...
                {
                    new InvestmentItem { Id = "INV000001", AccountName = "", CertificateNumber = "DFC123456", Status = "Active", Principal = 123000, Rate = "23% p.a", StartDate = new DateTime(2019,08,21), Maturity = 12000, MaturityDate = new DateTime(2020,2,12), InterestAmount = 2300, InterestEarned = 34300, Redemption = 102900, Days = "120" },
                    new InvestmentItem { Id = "INV000002", AccountName = "", CertificateNumber = "DFC425563", Status = "Active", Principal = 423000, Rate = "15% p.a", StartDate = new DateTime(2017,06,12), Maturity = 12000, MaturityDate = new DateTime(2017,12,19), InterestAmount = 6400, InterestEarned = 34300, Redemption = 62400, Days = "214" },
                    new InvestmentItem { Id = "INV000003", AccountName = "", CertificateNumber = "DFC523453", Status = "Active", Principal = 3266000, Rate = "23% p.a", StartDate = new DateTime(2017,05,23), Maturity = 12000, MaturityDate = new DateTime(2018,3,24), InterestAmount = 53300, InterestEarned = 43300, Redemption = 41900, Days = "22" },
                    new InvestmentItem { Id = "INV000004", AccountName = "", CertificateNumber = "DFC124121", Status = "Active", Principal = 8453000, Rate = "12% p.a", StartDate = new DateTime(2018,12,1), Maturity = 12000, MaturityDate = new DateTime(2019,6,10), InterestAmount = 12400, InterestEarned = 67300, Redemption = 16900, Days = "365" },
                    new InvestmentItem { Id = "INV000005", AccountName = "", CertificateNumber = "DFC010928", Status = "Active", Principal = 423000, Rate = "17.5% p.a", StartDate = new DateTime(2019,11,5), Maturity = 12000, MaturityDate = new DateTime(2020,3,11), InterestAmount = 3452, InterestEarned = 1232, Redemption = 1920, Days = "0" }
                } }
            });
        }
