...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Syncfusion.SfChart.XForms.Droid.ChartZoomPanBehaviorHelper, Syncfusion.SfChart.XForms.Android", ChartZoomPanBehaviorHelper.class, __md_methods);
	}
	...
	public ChartZoomPanBehaviorHelper ()
	{
		...
		if (getClass () == ChartZoomPanBehaviorHelper.class)
			mono.android.TypeManager.Activate ("Syncfusion.SfChart.XForms.Droid.ChartZoomPanBehaviorHelper, Syncfusion.SfChart.XForms.Android", "", this, new java.lang.Object[] {  });
	}
