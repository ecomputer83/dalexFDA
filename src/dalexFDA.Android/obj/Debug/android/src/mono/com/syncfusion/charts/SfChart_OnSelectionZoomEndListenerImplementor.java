...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Syncfusion.Charts.SfChart+IOnSelectionZoomEndListenerImplementor, Syncfusion.SfChart.Android", SfChart_OnSelectionZoomEndListenerImplementor.class, __md_methods);
	}


	public SfChart_OnSelectionZoomEndListenerImplementor ()
	{
		super ();
		if (getClass () == SfChart_OnSelectionZoomEndListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Charts.SfChart+IOnSelectionZoomEndListenerImplementor, Syncfusion.SfChart.Android", "", this, new java.lang.Object[] {  });
	}
