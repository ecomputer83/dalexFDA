...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Syncfusion.Charts.SfChart+IOnLabelsGeneratedListenerImplementor, Syncfusion.SfChart.Android", SfChart_OnLabelsGeneratedListenerImplementor.class, __md_methods);
	}


	public SfChart_OnLabelsGeneratedListenerImplementor ()
	{
		super ();
		if (getClass () == SfChart_OnLabelsGeneratedListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Charts.SfChart+IOnLabelsGeneratedListenerImplementor, Syncfusion.SfChart.Android", "", this, new java.lang.Object[] {  });
	}
