...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Syncfusion.Charts.SfChart+IOnSelectionChangingListenerImplementor, Syncfusion.SfChart.Android", SfChart_OnSelectionChangingListenerImplementor.class, __md_methods);
	}


	public SfChart_OnSelectionChangingListenerImplementor ()
	{
		super ();
		if (getClass () == SfChart_OnSelectionChangingListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Charts.SfChart+IOnSelectionChangingListenerImplementor, Syncfusion.SfChart.Android", "", this, new java.lang.Object[] {  });
	}
