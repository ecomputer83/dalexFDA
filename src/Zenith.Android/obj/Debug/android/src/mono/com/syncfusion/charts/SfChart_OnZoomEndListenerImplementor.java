...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Syncfusion.Charts.SfChart+IOnZoomEndListenerImplementor, Syncfusion.SfChart.Android", SfChart_OnZoomEndListenerImplementor.class, __md_methods);
	}


	public SfChart_OnZoomEndListenerImplementor ()
	{
		super ();
		if (getClass () == SfChart_OnZoomEndListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Charts.SfChart+IOnZoomEndListenerImplementor, Syncfusion.SfChart.Android", "", this, new java.lang.Object[] {  });
	}
