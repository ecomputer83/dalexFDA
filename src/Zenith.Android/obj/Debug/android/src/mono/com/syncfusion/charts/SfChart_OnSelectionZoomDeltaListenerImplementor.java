...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Syncfusion.Charts.SfChart+IOnSelectionZoomDeltaListenerImplementor, Syncfusion.SfChart.Android", SfChart_OnSelectionZoomDeltaListenerImplementor.class, __md_methods);
	}


	public SfChart_OnSelectionZoomDeltaListenerImplementor ()
	{
		super ();
		if (getClass () == SfChart_OnSelectionZoomDeltaListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Charts.SfChart+IOnSelectionZoomDeltaListenerImplementor, Syncfusion.SfChart.Android", "", this, new java.lang.Object[] {  });
	}
