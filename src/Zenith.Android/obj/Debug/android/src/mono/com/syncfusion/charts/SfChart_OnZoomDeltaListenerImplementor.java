...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Syncfusion.Charts.SfChart+IOnZoomDeltaListenerImplementor, Syncfusion.SfChart.Android", SfChart_OnZoomDeltaListenerImplementor.class, __md_methods);
	}


	public SfChart_OnZoomDeltaListenerImplementor ()
	{
		super ();
		if (getClass () == SfChart_OnZoomDeltaListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Charts.SfChart+IOnZoomDeltaListenerImplementor, Syncfusion.SfChart.Android", "", this, new java.lang.Object[] {  });
	}
