...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Syncfusion.Charts.SfChart+IOnScrollListenerImplementor, Syncfusion.SfChart.Android", SfChart_OnScrollListenerImplementor.class, __md_methods);
	}


	public SfChart_OnScrollListenerImplementor ()
	{
		super ();
		if (getClass () == SfChart_OnScrollListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Charts.SfChart+IOnScrollListenerImplementor, Syncfusion.SfChart.Android", "", this, new java.lang.Object[] {  });
	}
