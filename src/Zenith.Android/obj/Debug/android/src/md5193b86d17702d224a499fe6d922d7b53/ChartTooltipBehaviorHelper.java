...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Syncfusion.SfChart.XForms.Droid.ChartTooltipBehaviorHelper, Syncfusion.SfChart.XForms.Android", ChartTooltipBehaviorHelper.class, __md_methods);
	}
	...
	public ChartTooltipBehaviorHelper ()
	{
		...
		if (getClass () == ChartTooltipBehaviorHelper.class)
			mono.android.TypeManager.Activate ("Syncfusion.SfChart.XForms.Droid.ChartTooltipBehaviorHelper, Syncfusion.SfChart.XForms.Android", "", this, new java.lang.Object[] {  });
	}
