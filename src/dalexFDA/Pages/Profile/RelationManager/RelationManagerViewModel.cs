...
namespace dalexFDA
{
    ...
    public class RelationManagerViewModel : BaseViewModel
    {
        ...
        public bool RO { get; set; } = true;
        public bool noRO { get; set; }

        public ROResponse Profile { get; set; }
        public string DisplayName { get; set; }

        public Command ChangePhoto { get; set; }
         
        public RelationManagerViewModel(IErrorManager ErrorManager, ISession _SessionService, IAccountService AccountService, IUserDialogs Dialog, IMedia Media)
        {
        ...
        public async override void Init(object initData)
        {
            ...
            try
            {
                ...
                {
                    var ro = SessionService?.CurrentUser?.Ro;
                    Profile = await AccountService.GetRO(ro);
                    if(Profile == null)
                    {
                        noRO = true;
                        RO = false;
